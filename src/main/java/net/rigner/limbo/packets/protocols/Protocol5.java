 ...
 * All rights reserved.
 */
public class Protocol5 extends AbstractProtocol
{
    public Protocol5(NetworkManager networkManager)
    {
        ...
        this.registerPacketOut(Status.PLAY, 0x01, PacketPlayOutJoinGame5.class);
    ...
    {
        this.networkManager.sendPacket(playerConnection, new PacketPlayOutJoinGame5(entityId, gameMode, (byte)dimension, difficulty, maxPlayers, levelType));
    }
